...
void printHelp()
{
    ...
    std::cout << "The following options are available with prismatic, each documented as long form (short form) *parameters* : description\n"
              ...
              << "* --probe-defocus (-df) value : probe defocus (in angstroms). Sign convention: this value is equal to C_10. (default: " << defaults.probeDefocus << ")\n"
              ...
              << "* --aberrations (-aber) filename : filename containing list of arbitrary aberrations. See README.md for details \n"
